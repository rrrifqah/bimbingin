...
class _DaftarBimbinganScreenState extends State<DaftarBimbinganScreen> {
  ...
  /// Tampilkan bottom sheet detail mahasiswa (Profil, Booking, Progres)
                  ...
                  child: TabBarView(
                    children: [
                        ...
                        children: [
                          ...
                          Expanded(
                            child: tahapList.isEmpty
                                ? const Center(child: Text('Belum ada data progres.'))
                                : ListView.builder(
                                    padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 8),
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return _buildTimelineItemDosen(ctx, p, isLast, mahasiswaId);
                                    },
                                  ),
                          ),
                        ],
                      ...
                      FutureBuilder<List<BookingModel>>(
                        future: SupabaseService().getBookingByMahasiswa(mahasiswaId),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (b.catatanStaf != null && b.catatanStaf!.isNotEmpty) ...[
                                        const SizedBox(height: 8),
                                        Text('Catatan: ${b.catatanStaf}', style: const TextStyle(color: Colors.red, fontSize: 12)),
                                      ],
                                    ],
                                  ),
                                ),
                      ...
                      FutureBuilder<UserModel?>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (u == null) return const Center(child: Text('Gagal memuat profil'));
                          
                          // Also fetch target
                          final targetProvider = context.read<TargetProvider>();
                          final targetData = targetProvider.allTargets.where((t) => t['mahasiswa_id'] == mahasiswaId).firstOrNull;
                            ...
                            child: Column(
                              children: [
                                CircleAvatar(
                                  ...
                                  child: Text(
                                    u.nama.isNotEmpty ? u.nama[0].toUpperCase() : 'M',
                                    style: TextStyle(color: primaryColor, fontSize: 32, fontWeight: FontWeight.bold),
                                  ),
                                ),
                                const SizedBox(height: 16),
                                Text(u.nama, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                                Text(u.nimNip, style: const TextStyle(color: Colors.grey)),
                                ...
                                if (targetSelesai != null)
                                  ListTile(
                                    ...
                                    subtitle: Text(DateFormat('dd MMMM yyyy').format(DateTime.parse(targetSelesai))),
                                  ),
                              ],
                            ),
                          );
